...
class MediaManagementS3BucketsStack(Construct):
    ...
    def __init__ (self, scope: Construct, construct_id: str, id, logging_bucket_name, input_bucket_name,
                  output_bucket_name, cors_allowed_origin:str="https://*.force.com",encryption_key: kms.IKey = None, **kwargs) -> None:
    ...
    def create_s3_bucket_stack (self, id, bucket_name: str, log_file_prefix: str):
